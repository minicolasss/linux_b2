...
| ------- | ------------- | ---------------- | ---------- |color-scripts----------- | ---- | --------------- | ------------------------------------------------------ |
| **WAN** | Internet         | pfsense (WAN)         | DHCP / IP Publique    | -    | FAI             | Connexion Internet                                     |
| **10**  | **DMZ**          | pfsense (Interface)   | 192.168.10.1          | /24  | -               | Passerelle pour la DMZ                                 |
...
| **20**  | **MGMT / ADMIN** | pfsense (Interface)   | 192.168.20.1          | /24  | -               | Passerelle d'administration                            |
...
| **30**  | **SERVICES**     | pfsense (Interface)   | 192.168.30.1          | /24  | -               | Passerelle interne                                     |
| 30      | SERVICES         | **Serveur_DNS**        | 192.168.30.10         | /24  | 192.168.30.1    | Résolution de noms interne                             |
| **40**  | **BACKUP**       | pfsense (Interface)   | 192.168.40.1          | /24  | -               | Passerelle backup (très filtrée)                       |
| 40      | BACKUP           | **Backup_1**           | 192.168.40.10         | /24  | 192.168.40.1    | Serveur de stockage des sauvegardes                    |
| **50**  | **LAN_USER**     | pfsense (Interface)   | 192.168.50.1          | /24  | -               | Passerelle pour les employés                           |
